  ...
  carregarRegistros: async () => {
    ...
    try {
      ...
      const registrosTransformados = (data || []).map((reg) => ({
        ...
        caesMachoVacinados: reg.caes_macho_vacinados || 0,
        caesFemeaVacinadas: reg.caes_femea_vacinadas || 0,
        gatosMachoVacinados: reg.gatos_macho_vacinados || 0,
        gatosFemeaVacinadas: reg.gatos_femea_vacinadas || 0,
        data: reg.data,
        tutor: reg.tutor,
  ...
  adicionarRegistro: async (registro) => {
    ...
    try {
      ...
      const registroSupabase = {
        ...
        // Campos de vacinação individual
        caes_macho_vacinados: registro.caesMachoVacinados || 0,
        caes_femea_vacinadas: registro.caesFemeaVacinadas || 0,
        gatos_macho_vacinados: registro.gatosMachoVacinados || 0,
        gatos_femea_vacinadas: registro.gatosFemeaVacinadas || 0,
        data: registro.data,
  ...
  atualizarRegistro: async (id, dadosAtualizados) => {
    ...
    try {
      ...
      const registroSupabase = {
        ...
        // Campos de vacinação individual
        caes_macho_vacinados: dadosAtualizados.caesMachoVacinados || 0,
        caes_femea_vacinadas: dadosAtualizados.caesFemeaVacinadas || 0,
        gatos_macho_vacinados: dadosAtualizados.gatosMachoVacinados || 0,
        gatos_femea_vacinadas: dadosAtualizados.gatosFemeaVacinadas || 0,
