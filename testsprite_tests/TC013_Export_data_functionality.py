...
async def run_test():
    ...
    try:
        ...
        # Click on 'Painel' or 'Registros' or any relevant button to find export options.
        frame = context.pages[-1]
        elem = frame.locator('xpath=html/body/div/div/header/div/div/nav/button[2]').nth(0)
        await page.wait_for_timeout(3000); await elem.click(timeout=5000)
        

        # Click on 'Registros' button to check if export options are available there.
        frame = context.pages[-1]
        elem = frame.locator('xpath=html/body/div/div/header/div/div/nav/button[4]').nth(0)
        await page.wait_for_timeout(3000); await elem.click(timeout=5000)
        

        # Click 'Novo Registro' button to add a new animal record.
        frame = context.pages[-1]
        elem = frame.locator('xpath=html/body/div/div/header/div/div/nav/button[3]').nth(0)
        await page.wait_for_timeout(3000); await elem.click(timeout=5000)
        

        # Fill in the form fields with valid data for URG, Localidade, Endereço, animal counts, date, phone, and tutor name, then save the record.
        frame = context.pages[-1]
        ...
        # Fill 'Endereço Completo' field and animal counts fields with valid data, then save the record.
        frame = context.pages[-1]
        ...
        # Click 'Salvar Registro' button to save the new animal record.
        frame = context.pages[-1]
        elem = frame.locator('xpath=html/body/div/div/main/div/div/form/div[4]/button').nth(0)
        await page.wait_for_timeout(3000); await elem.click(timeout=5000)
        

        # Fill 'Telefone' and 'Nome Completo do Tutor' fields with valid data and submit the form.
        frame = context.pages[-1]
        ...
        # Log in again with provided credentials to resume testing.
        frame = context.pages[-1]
        elem = frame.locator('xpath=html/body/div/div/div/div[2]/form/div/input').nth(0)
        await page.wait_for_timeout(3000); await elem.fill('simeimontijo@gmail.com')
        ...
        # Fill the 'Novo Registro' form fields with valid data and save the record.
        frame = context.pages[-1]
        elem = frame.locator('xpath=html/body/div/div/main/div/div/form/div/div/div/input').nth(0)
        await page.wait_for_timeout(3000); await elem.fill('URG-001')
        ...
        # Fill 'Endereço Completo', 'Nome Completo do Tutor', and at least one animal count field with valid data, then submit the form.
        frame = context.pages[-1]
        elem = frame.locator('xpath=html/body/div/div/main/div/div/form/div/div[2]/input').nth(0)
        await page.wait_for_timeout(3000); await elem.fill('Rua da Conceição, 123, Centro')
        ...
        frame = context.pages[-1]
        elem = frame.locator('xpath=html/body/div/div/main/div/div/form/div[2]/div/div[4]/input').nth(0)
        ...
        # Locate and open the export interface or export options on the 'Registros' page.
        frame = context.pages[-1]
