...
async def run_test():
    ...
    try:
        ...
        # Open a new tab and log in as User B with the same credentials.
        frame = context.pages[-1]
        ...
        # Try to refresh the page or navigate to 'Registros' to check if data loads or if the loading issue persists.
        frame = context.pages[-1]
